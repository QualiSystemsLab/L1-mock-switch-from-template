...
### Configuration
Follow the steps in CloudShell Help's [L1 Switches](https://help.quali.com/Online%20Help/0.0/Portal/Content/Admn/Cnct-Ctrl-L1-Swch.htm?Highlight=l1) article to learn how to import and set up the layer 1 switch resource in CloudShell.
